        ...
        <form onSubmit={handleSendOTP} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-2xl border border-[#ddd7cd] bg-[#fcfbf8] text-surface-900 placeholder-surface-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 transition-all duration-200 text-sm"
              value={form.fullname}
