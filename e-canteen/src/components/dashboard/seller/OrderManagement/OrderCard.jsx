...
export default function OrderCard({ order, updateOrderStatus, getOrderDetails }) {
  ...
  return (
    <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm hover:shadow-md hover:border-orange-200 transition-all duration-300 group">
      ...
      {Icon && orderDetails.status !== 'completed' && (
        <button
          ...
          className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-xl flex justify-center items-center gap-2 font-medium transition-all duration-200 shadow-sm hover:shadow-md"
        >
