        ...
        <div className="flex justify-between items-center mb-6">
          ...
          {!isEditingProfile ? (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-medium transition-all duration-200"
            >
        ...
        <div className="flex items-center gap-6 mb-8 p-6 border border-gray-200 rounded-xl">
          <div className="relative">
            {userProfile.avatar ? (
              ...
              <div className="w-24 h-24 bg-orange-500 rounded-full flex items-center justify-center border-4 border-orange-100">
      ...
      {isEditing ? (
        type === "textarea" ? (
          <textarea
            ...
            className="w-full p-3 border border-gray-300 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition-all duration-200 resize-none"
            rows="3"
          ...
          <input
            ...
            value={value}
            onChange={(e) => onChange(field, e.target.value)}
            className="w-full p-3 border border-gray-300 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-100 transition-all duration-200"
            placeholder={placeholder}
          />
        )
      ) : (
