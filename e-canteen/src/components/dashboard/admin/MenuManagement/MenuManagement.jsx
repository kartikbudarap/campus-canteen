    ...
    <>
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => openModal()}
            className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-xl flex gap-2 items-center shadow-sm hover:shadow-md transition-all duration-300 font-medium hover:scale-105"
          >
