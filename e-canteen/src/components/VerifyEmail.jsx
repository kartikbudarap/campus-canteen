...
export default function VerifyEmail({ userEmail, onVerificationComplete, onResendEmail, tempToken }) {
  ...
  if (verificationStatus === 'success') {
    return (
      <div className="space-y-6 text-center">
        ...
        <div>
          <h1 className="text-3xl font-black text-[#17211b] tracking-[-0.035em]">Email verified!</h1>
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-black text-[#17211b] tracking-[-0.035em]">Verify your email</h1>
