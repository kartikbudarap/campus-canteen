...
export default function ForgotPassword() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-black text-[#17211b] tracking-[-0.035em]">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-2xl border border-[#ddd7cd] bg-[#fcfbf8] text-surface-900 placeholder-surface-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 transition-all duration-200 text-sm"
                value={form.email}
          ...
          <button
            ...
            className={`w-full py-3 rounded-xl font-semibold text-sm transition-all duration-200 shadow-sm hover:shadow-lg flex items-center justify-center gap-2.5 ${
              loading
                ...
                : "bg-[#17211b] hover:bg-[#26352c] text-white active:scale-[0.98]"
            }`}
          >
            {loading ? (
              <>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                value={form.otp}
                onChange={handleChange}
                className="w-full pl-10 pr-4 py-3 text-center text-2xl font-bold tracking-[0.3em] rounded-2xl border border-[#ddd7cd] bg-[#fcfbf8] text-surface-900 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 transition-all duration-200"
                disabled={loading}
                required
              />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 rounded-2xl border border-[#ddd7cd] bg-[#fcfbf8] text-surface-900 placeholder-surface-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-100 transition-all duration-200 text-sm"
