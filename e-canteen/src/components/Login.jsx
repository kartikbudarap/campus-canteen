...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Header */}
      <div>
        <h1 className="text-3xl font-black text-[#17211b] tracking-[-0.035em]">Sign in to your account</h1>
        <p className="text-surface-500 mt-1.5">Choose your workspace and continue where you left off.</p>
      </div>
            ...
            {roles.map((roleOption) => {
              ...
              return (
                <button
                  ...
                  disabled={loading}
                  className={`relative p-3.5 rounded-2xl border transition-all duration-200 text-center group whitespace-normal ${
                    isActive
                      ? "bg-[#fff3eb] border-[#ee6a3c] text-[#9d3717] shadow-sm"
                      : "bg-[#faf9f6] border-[#e7e2d9] text-surface-600 hover:border-[#cfc8bb] hover:bg-white"
